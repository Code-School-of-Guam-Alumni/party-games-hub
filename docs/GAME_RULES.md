...
1. Enter 3–8 player names and choose a word pack. Four to eight players is recommended.
...
7. A tied group gives the tied players one additional clue and votes again.
